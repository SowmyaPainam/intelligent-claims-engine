...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("AuditLogListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheAuditLogListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheAuditLogListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheAuditLogListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheAuditLogListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheAuditLogListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheAuditLogListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheAuditLogListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheAuditLogListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheAuditLogListGenerated.onTable(defaultTableId).iPressRow(0);
