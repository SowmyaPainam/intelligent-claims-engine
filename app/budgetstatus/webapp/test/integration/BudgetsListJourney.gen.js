...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("BudgetsListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheBudgetsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheBudgetsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheBudgetsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheBudgetsListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheBudgetsListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheBudgetsListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheBudgetsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheBudgetsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheBudgetsListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheBudgetsObjectPageGenerated.iSeeThisPage();
        });
